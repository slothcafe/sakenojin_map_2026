...
| 会場ガイド | 味わいナビ | 巡歴 |
| :---: | :---: | :---: |
| <img src="doc/event_map.jpeg" width="100%"> | <img src="doc/heatmap.jpeg" width="100%"> | <img src="doc/history.jpeg" width="100%"> |
| 会場全体を見ながらブースを選択 | 味わい軸に応じたヒートマップ表示 | 地域毎の訪問状況, 巡回ルート, タイムラインの振り返り |
